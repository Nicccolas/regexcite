...
devtools::install_github("Nicccolas/regexcite")
```
...
That’s exactly what `regexcite::str_split_one()` does. What is special
about using `README.Rmd` instead of just `README.md`? You can include R
chunks like so:
